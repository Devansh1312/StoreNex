...
<p>Hello {{ $user->name }},</p>
<p>Welcome to StoreNex. Thank you for signing up!</p>
<p>Please verify your account by clicking the button below:</p> @component('mail::button', ['url' => $verificationUrl]) Verify @endcomponent <p>In case of any issues, please contact our Contact Us Page.</p> Thanks, <br>
      ...
      <style>
         * {
         ...
         @media (max-width:660px) {
            ...
            .row-4 .column-1 .block-1.social_block td.pad {
            ...
            .row-3 .column-1 .block-6.button_block a,
            .row-3 .column-1 .block-6.button_block div,
                                                ...
                                                <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                   <div class="alignment" align="center" style="line-height:10px">
                                                      <div style="max-width: 160px;">
                                                         <a href="www.example.com" target="_blank" style="outline:none" tabindex="-1">
                                                            <img src="{{ asset('storage/SystemSetting/systemlogo.png') }}" style="display: block; height: auto; border: 0; width: 100%;" width="160" alt="Your logo." title="Your logo.">
                                                         </a>
                                                      </div>
                                                   </div>
                                                </td>
                                                ...
                                                <td class="pad" style="width:100%;">
                                                   <div class="alignment" align="center" style="line-height:10px">
                                                      <div style="max-width: 640px;">
                                                         <a href="www.example.com" target="_blank" style="outline:none" tabindex="-1">
                                                            <img src="https://d15k2d11r6t6rl.cloudfront.net/pub/bfra/js8y22ax/xxr/iuu/64e/801a3012-640f-4f88-aa43-61e1df18bf19.jpg" style="display: block; height: auto; border: 0; width: 100%;" width="640" alt="Image of lock &amp; key." title="Image of lock &amp; key.">
                                                         </a>
                                                      </div>
                                                   </div>
                                                </td>
                                          ...
                                          <table class="paragraph_block block-5" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                             <tr>
                                                <td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
                                                   <div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:15px;line-height:150%;text-align:center;mso-line-height-alt:22.5px;">
                                                      <p style="margin: 0; word-break: break-word;">
                                                         <span style="color: #808389;">StoreNex You One Step E-Commerce Platform</span>
                                                      </p>
                                                   </div>
                                                </td>
                                             </tr>
                                                   ...
                                                   <div class="alignment" align="center">
                                                      <!--[if mso]>
																								<v:roundrect
																									...
																									xmlns:w="urn:schemas-microsoft-com:office:word" href="www.example.com" style="height:62px;width:103px;v-text-anchor:middle;" arcsize="57%" stroke="false" fillcolor="#f7a50c">
																									<w:anchorlock/>
																									<v:textbox inset="0px,0px,0px,0px">
																										<center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px">
																											<![endif]--> @component('mail::button', ['url' => $verificationUrl]) Verify @endcomponent
                                                      <!--[if mso]>
																										</center>
																									</v:textbox>
																								</v:roundrect>
                                                      ...
                                                      <table class="social-table" width="208px" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; display: inline-block;">
                                                         <tr>
                                                            <td style="padding:0 10px 0 10px;">
                                                               <a href="https://www.facebook.com/redsparktech/" target="_blank">
                                                            ...
                                                            <td style="padding:0 10px 0 10px;">
                                                               <a href="https://twitter.com/redsparkinfo" target="_blank">
                                                            ...
                                                            <td style="padding:0 10px 0 10px;">
                                                               <a href="https://www.instagram.com/redspark_tech/" target="_blank">
                                                            ...
                                                            <td style="padding:0 10px 0 10px;">
                                                               <a href="https://www.linkedin.com/company/redspark/mycompany/" target="_blank">
                                             ...
                                             <tr>
                                                <td class="pad" style="padding-bottom:30px;padding-left:40px;padding-right:40px;padding-top:20px;">
                                                   <div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:12px;line-height:120%;text-align:center;mso-line-height-alt:14.399999999999999px;">
                                                      <p style="margin: 0; word-break: break-word;">
                                                         <span style="color: #95979c;">StoreNex Copyright © 2024</span>
                                                      </p>
                                                   </div>
                                                </td>
                                             </tr>
