                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-12">
                                    <div class="card-block">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <p class="m-b-10 f-w-600">Current Order Status</p>
                                                @php
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <form method="POST" action="{{ route('UpdateTransaction', base64_encode($transaction->id)) }}">
                                                    @csrf
                                                    <div class="form-group">
                                                        <select name="order_status" class="form-control">
                                                            <option value="Pending" {{ $transaction->order_status === 'Pending' ? 'selected' : '' }}>Pending</option>
                                                            <option value="Accepted" {{ $transaction->order_status === 'Accepted' ? 'selected' : '' }}>Accepted</option>
                                                            <option value="Canceled" {{ $transaction->order_status === 'Canceled' ? 'selected' : '' }}>Canceled</option>
                                                        </select>
                                                    </div>
